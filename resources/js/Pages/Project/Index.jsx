...
export default function Index({
  ...
  const deleteProject = (project) => {
    if (!window.confirm("Are you sure you whant to delete this project?")) {
      return;
    }
                ...
                dark:text-gray-400 border-b-2 border-gray-500"
                  >
                    <tr className="text-nowrap">
                      ...
                      <TableHeadding name="image" sortable={false}>
                        Image
                      </TableHeadding>
                      <TableHeadding
                        name="name"
                  ...
                  <tbody>
                    ...
                    dark:border-gray-700 border-b"
                      ...
                      >
                        ...
                        <th className="px-3 py-2 hover:underline text-gray-200 text-nowrap">
